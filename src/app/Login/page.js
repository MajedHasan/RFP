      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <div className="relative">
          ...
          <label
            ...
            className={`absolute left-0 -top-3.5 text-gray-600 text-sm ${
              formData.email ? '-top-3.5' : 'peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2'
        ...
        <div className="relative">
          ...
          <label
            htmlFor="password"
            className={`absolute left-0 -top-3.5 text-gray-600 text-sm ${
              formData.password ? '-top-3.5' : 'peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2'
            } transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm`}
          >
            Password
          </label>
        ...
        <div className="flex flex-row justify-between items-center">
          <Link  className="text-sm py-4 text-[#002D74] hover:underline"  
           href="/forgotpassword" passHref>
              Forgot password?
          </Link>
          <button
            type="submit"
